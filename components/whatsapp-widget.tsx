export default function WhatsAppWidget() {
  ...
  return (
    <div className="fixed bottom-6 left-6 z-50 hidden lg:flex flex-col gap-3">
      <a href={`tel:+${phone}`} className="w-12 h-12 rounded-full flex items-center justify-center shadow-xl transition-all hover:scale-110" style={{background:"#4A5C3A"}}>
      ...
      <a href={`https://wa.me/${phone}?text=${msg}`} target="_blank" rel="noopener noreferrer"
        className="w-12 h-12 bg-green-500 hover:bg-green-600 rounded-full flex items-center justify-center shadow-xl transition-all hover:scale-110">
